...
echo "========================================="
echo "Parsing all 10K input + 2K output benchmark results"
echo "========================================="
echo ""
...
# Find and parse all test3_10Kin_2Kout_port*.json files
for file in benchmark_results/test3_10Kin_2Kout_port*.json; do
    if [ -f "$file" ]; then
        ((total++))
